...
function getDitheringHandler({ canvas, convetCoordsToCanvasRect, globalState }) {
  function onMouseDown(mouseDownEvt) {
    ...
    function stroke(coords, coords2) {
      ...
      globalState.view.paintPath([i, j], [i2, j2], globalState.subCurrColor, globalState.currColor);
...
export default getDitheringHandler;
